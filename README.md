...
- **[DesktopCommander](https://github.com/wonderwhy-er/DesktopCommanderMCP)** - Edit and manage files on your computer, run any command in the terminal, and even connect to remote servers using SSH with a most popular local MCP server.
