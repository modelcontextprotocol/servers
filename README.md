...
- **[JSON MCP]([https://github.com/GongRzhe/JSON-MCP-Server](https://github.com/VadimNastoyashchy/json-mcp))** - JSON (MCP) server empowers LLMs to efficiently interact with JSON files. With JSON MCP, you can split, merge, find specific data, and validate within JSON files based on defined conditions.
