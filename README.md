...
- <img height="12" width="12" src="https://marketing.qasphere.com/images/logo/qasphere-square-512.png" alt="QA Sphere Logo" /> [QA Sphere](https://github.com/Hypersequent/qasphere-mcp) - Integration with QA Sphere test management system, enabling LLMs to discover, summarize, and interact with test cases directly from AI-powered IDEs
