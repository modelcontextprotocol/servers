...
- **[EventTrader](https://github.com/eventtrader/event-trader)** — AI-native prediction market platform. 9 CLOB pairs (0% maker fees), 10 clonable trading agents, agent-to-agent messaging, AgentBook social network, AI due diligence scoring. ([PyPI](https://pypi.org/project/cymetica-eventtrader-mcp/))
