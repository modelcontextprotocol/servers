...
- **[MSSQL-Python](https://github.com/amornpan/py-mcp-mssql)** (by amornpan) - Read-only MSSQL database integration in Python with configurable access controls and schema inspection
