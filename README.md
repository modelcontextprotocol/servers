...
* **[Promptise Foundry](https://github.com/promptise-com/foundry)** (Python) - A production MCP framework for building secure, scalable servers with real access control and a FastAPI-style developer experience.
