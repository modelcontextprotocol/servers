...
- **[Vocametrix](https://github.com/pmarmaroli/vocametrix-mcp)** - Voice analysis and clinical speech metrics — AVQI, DSI, jitter/shimmer, pronunciation assessment, prosody similarity, and 40+ more endpoints for SLPs, voice researchers, and healthtech apps.
