...
- **[Awesome Japanese MCP](https://github.com/Shown06/awesome-japanese-mcp)** - Curated list of MCP servers built by Japanese developers, for Japanese services — 補助金 / 助成金, App Store JP, 日本語 AIO/SEO, and other Japan-vertical sources by **[Shown](https://github.com/Shown06)**
