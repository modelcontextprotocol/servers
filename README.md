...
- <img height="12" width="12" src="https://www.dremio.com//wp-content/themes/subsurface/assets/_corp/favicon.ico" alt="Dremio Logo" /> **[Dremio MCP Server](https://github.com/dremio/dremio-mcp)** - Interact with [Dremio](https://www.dremio.com), the Intelligent Lakehouse Platform, to let agents discover and query your data, build natural-language interfaces to your lakehouse, enable automated workflows powered by agents and so much more!
