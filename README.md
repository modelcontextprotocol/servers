...
- **[MariaDB MCP Server](https://github.com/MariaDB/mcp)** - The official MariaDB MCP Server for managing and querying MariaDB databases supporting both, standard SQL operations, and advanced vector/embedding-based search.
