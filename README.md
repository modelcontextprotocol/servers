...
- **[Apache Gravitino (incubating)](https://github.com/datastrato/mcp-server-gravitino)** - Allows LLMs to explore metadata of structured data and unstructured data with Gravitino, and perform data governance tasks including tagging/classification.
...
- **[browser-use](https://github.com/co-browser/browser-use-mcp-server)** (by co-browser) - MCP server for browser automation using Dockerized Playwright with Chromium and VNC. Supports stdio and resumable HTTP.
...
- **[ChatSum](https://github.com/mcpso/mcp-server-chatsum)** - Query and Summarize chat messages with LLM by [mcp.so](https://mcp.so).
...
- **[deepseek-thinker-mcp](https://github.com/ruixingshi/deepseek-thinker-mcp)** - An MCP (Model Context Protocol) provider Deepseek reasoning content to MCP-enabled AI Clients, like Claude Desktop. Supports access to Deepseek's thought processes from the Deepseek API service or from a local Ollama server.
...
- **[dune-analytics-mcp](https://github.com/kukapay/dune-analytics-mcp)** -  An MCP server that bridges Dune Analytics data to AI agents.
...
- **[FDIC BankFind MCP Server - (Unofficial)](https://github.com/clafollett/fdic-bank-find-mcp-server)** - The is an MCP server that brings the power of FDIC Bank Find APIs straight to your AI tools and workflows. Structured U.S. banking data, delivered with maximum vibes. 😎📊
- **[Fetch](https://github.com/zcaceres/fetch-mcp)** - A server that flexibly fetches HTML, JSON, Markdown, or plain text.
- **[Fingertip](https://github.com/fingertip-com/fingertip-mcp)** - MCP server for [fingertip.com](https://fingertip.com) to search and create new sites.
...
- **[Google Sheets](https://github.com/xing5/mcp-google-sheets)** - Access and edit data to your Google Sheets.
...
- **[GraphQL Schema](https://github.com/hannesj/mcp-graphql-schema)** - Allows LLMs to explore large GraphQL schemas without bloating the context.
...
- **[OpenAPI Schema](https://github.com/hannesj/mcp-openapi-schema)** - Allows LLMs to explore large [OpenAPI](https://www.openapis.org/) schemas without bloating the context.
...
- **[Placid.app](https://github.com/felores/placid-mcp-server)** - Generate image and video creatives using [placid.app](https://placid.app) templates.
...
- **[QuickChart](https://github.com/GongRzhe/Quickchart-MCP-Server)** - A Model Context Protocol server for generating charts using [QuickChart.io](https://quickchart.io).
...
- **[Teradata](https://github.com/arturborycki/mcp-teradata)** - This MCP server enables LLMs to interact with Teradata databases. This MCP Server support tools and prompts for multi task data analytics.
...
- **[whale-tracker-mcp](https://github.com/kukapay/whale-tracker-mcp)**  -  An MCP server for tracking cryptocurrency whale transactions.
...
- **[WildFly MCP](https://github.com/wildfly-extras/wildfly-mcp)** - WildFly MCP server that enables LLM to interact with running WildFly servers (retrieve metrics, logs, invoke operations etc.).
...
- **[MCP X Community](https://x.com/i/communities/1861891349609603310)** – An X community for MCP by **[Xiaoyi](https://x.com/chxy)**
