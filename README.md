...
- **[DesktopCommander](https://github.com/wonderwhy-er/DesktopCommanderMCP)** - A local MCP server that lets you manage files on your computer, run any command like in the terminal, and even connect to other computers remotely using SSH.
