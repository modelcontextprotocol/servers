...
- **[Moralis Web3](https://github.com/dein-username/moralis-mcp-server)** – Access Moralis Web3 APIs via MCP to query NFTs, tokens, wallets, and DeFi data across multiple blockchains.
