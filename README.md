...
- **[mcp-scope](https://github.com/SSanju/mcp-scope)** - Passive JSON-RPC capture, viewer, stats, and breaking-change schema diff that sits transparently between any MCP client and any MCP server. CI-gating exit code on breaking changes; pipe-friendly view, interactive TUI, latency stats, and replay. By **[SSanju](https://github.com/SSanju)**.
