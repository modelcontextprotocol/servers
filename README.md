...
- **[Wordpress](https://github.com/kurtseifried/mcp-servers-kurtseifried/tree/main/src/wordpress)** - MCP Server for interacting with a Wordpress site (via REST API).
