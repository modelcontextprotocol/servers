...
- **[CAD-MCP](https://github.com/daobataotie/CAD-MCP)** (by daobataotie) - CAD MCP Server,supports multiple versions of CAD(AutoCAD,Gstarcad,ZWCAD...), can be used to draw common entitys(line,arc,hatch,text,dimension...).
