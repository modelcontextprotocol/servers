...
- **[Excel](https://github.com/haris-musa/excel-mcp-server)** - Excel file manipulation including data reading/writing, worksheet management, formatting, charts, and pivot table.
