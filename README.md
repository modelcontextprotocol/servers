...
- **[Base L2 Agent Kit](https://github.com/manteclaw/litcoiin-solutions)** - 9-tool MCP server for Base L2 DeFi operations (contract audit, gas estimates, yield farming, token analysis, wallet health, DEX quotes) with x402 micropayment support
