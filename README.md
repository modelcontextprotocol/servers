...
- <img height="12" width="12" src="https://dynamodb-toolshack-public-assets.s3.us-east-1.amazonaws.com/logo.svg" alt="DynamoDB-Toolbox Logo" /> **[DynamoDB-Toolbox](https://www.dynamodbtoolbox.com/docs/databases/actions/mcp-toolkit)** - Leverages your Schemas and Access Patterns to interact with your [DynamoDB](https://aws.amazon.com/dynamodb) Database using natural language.
