...
- **[nodemailer](https://github.com/kurtseifried/mcp-servers-kurtseifried/tree/main/src/nodemailer)** - Nodemail integration so you can send email (e.g. summary of conversation, output of command).
