...
- <img height="12" width="12" src="https://www.mailjet.com/favicon.ico" alt="Mailjet Logo" /> **[Mailjet](https://github.com/mailgun/mailjet-mcp-server)** - Official [Sinch Mailjet](https://www.mailjet.com) MCP server which allows AI agents to interact with Mailjet's contact, campaign, segmentation, statistics, workflow (and more) APIs.
