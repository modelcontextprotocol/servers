...
- **[USPTO]([https](https://github.com/riemannzeta/patent_mcp_server))** - MCP server for accessing United States Patent & Trademark Office data through its Open Data Protocol (ODP) API.
