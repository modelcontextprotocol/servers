...
- **[MCP Servers Hub](https://github.com/apappascs/mcp-servers-hub)** (**[website](https://mcp-servers-hub-website.pages.dev/)**) - A growing directory of high-quality MCP servers with clear setup guides for a variety of MCP clients.
- **[MCPServers.com](https://mcpservers.com)** - A curated list of MCP servers by **[apappascs](https://github.com/apappascs)**
