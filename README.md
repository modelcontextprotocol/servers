...
- <img height="12" width="12" src="https://code.groundlight.ai/python-sdk/img/favicon.ico" alt="Groundlight Logo" /> **[Groundlight](https://github.com/groundlight/groundlight-mcp-server)** - Computer vision API from [Groundlight](https://www.groundlight.ai/) that answers natural language questions about images with confidence scores.
