...
* **[SkillForge](https://github.com/vardhineediganesh877-ui/skillforge)** (TypeScript) - MCP server framework with encrypted credentials, skill registry, pipelines, feature flags, and web dashboard
