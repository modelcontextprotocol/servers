...
- <img height="12" width="12" src="https://keywordseverywhere.com/favicon.ico" alt="Keywords Everywhere Logo" /> **[Keywords Everywhere](https://api.keywordseverywhere.com/docs/#/mcp_integration)** – Access keyword metrics and SERP data through the official Keywords Everywhere API MCP server.
