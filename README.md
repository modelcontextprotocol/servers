...
- **[Orihime](https://github.com/srinivasan-sundaresan95/orihime)** - Cross-repository code knowledge graph for Java, Kotlin, JavaScript, and TypeScript. Indexes source code into an embedded KuzuDB graph using tree-sitter and exposes 30+ MCP tools for call-flow tracing, taint analysis (OWASP/CWE/PCI/STIG), performance hotspot detection, and license compliance — without reading source files. 95% fewer tokens than source-reading. by **[Srinivasan Sundaresan](https://github.com/srinivasan-sundaresan95)**
