...
- <img height="12" width="12" src="https://www.plugged.in/favicon.ico" alt="Plugged.in Logo" /> **[Plugged.in](https://github.com/VeriTeknik/pluggedin-mcp-proxy)** - A social platform for the MCP ecosystem that combines multiple MCP servers into a unified proxy. Features user profiles, server/collection sharing, community discovery, an enhanced playground with RAG integration, and internationalization support. Available as cloud-hosted or self-hosted solutions.
