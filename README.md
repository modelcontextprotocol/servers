...
- **[Grasp](https://github.com/aircodelabs/grasp)** - Self-hosted agentic browser with built in MCP support. Allow to client to operate an isolated browser environment.
