...
- **[Open Index](https://github.com/DrDroidLab/open-index)** - An open-source toolkit for building searchable, structured context graphs that agents can query and maintain through MCP.
