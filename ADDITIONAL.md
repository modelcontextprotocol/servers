...
- **[Awesome Crypto MCP Servers by Hive Intelligence](https://github.com/hive-intel/awesome-crypto-mcp-servers)** - A maintained list of crypto, Web3, DeFi, wallet, trading, on-chain data, and blockchain MCP servers by **[Hive Intelligence](https://github.com/hive-intel)**
