...
- **[tooltrim](https://github.com/nac7/tooltrim)** - Compressing MCP gateway that wraps any MCP server over stdio and reduces tool-result tokens 94–99% (query-aware, full output retrievable on demand via a ref) before they re-enter model context. `pip install tooltrim[mcp]`
