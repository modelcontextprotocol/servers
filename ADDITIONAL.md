...
- **[Calera FinanceSec](https://finsec.caleralabs.com)** - Certified SEC EDGAR fact retrieval with cryptographic filing provenance, zero LLM hallucination, valuation packs, and deterministic CAGR calculation. Remote streamable-HTTP at `https://finsec.caleralabs.com/mcp`.
