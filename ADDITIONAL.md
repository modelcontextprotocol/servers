...
- **[MySpec](https://myspec.dev)** ([GitHub](https://github.com/nhconganhmedia/myspec-mcp)) - Spec-Driven Development (SDD) workspace and MCP server generating structured 4-file spec context bundles (`constitution`, `requirements`, `solution`, `tasks`) for Cursor and Claude Code.
