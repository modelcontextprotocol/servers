...
- **[skillet](https://github.com/Brattlof/skillet)** - A zero-dependency Go CLI / package manager that installs MCP servers into Claude Code, Cursor, Windsurf, Gemini CLI, and Cline (plus Agent Skills across tools and Claude Code slash commands and hooks) by **[Brattlof](https://github.com/Brattlof)**
