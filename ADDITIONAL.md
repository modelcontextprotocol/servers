...
- **[DatasheetVend](https://github.com/FelixNovaNexus/datasheet-vend) - Hardware truth contract & IPC-7351 CAD generation MCP server for AI agents. Extracts pinouts, document maps, footprints, and thermal/timing specs from datasheets with Stripe MPP micro-billing. [datasheetvend.com](https://datasheetvend.com/)
