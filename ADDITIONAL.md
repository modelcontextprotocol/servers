...
* **[InterMCP](https://github.com/Bharathcoorg/intermcp)** (Rust) - Ultra-fast, safe Model Context Protocol (MCP) runtime and multiplexing hub in pure Rust with sub-millisecond dispatch, SafeFS sandboxing, and 1-click multi-IDE auto-configuration.
