...
- **[skillet](https://github.com/Brattlof/skillet)** - A tiny, zero-dependency Go CLI / package manager that installs MCP servers (plus open-standard Agent Skills, slash commands, and hooks) into Claude Code, Cursor, OpenAI Codex, Gemini CLI, Copilot, and Cline by **[Brattlof](https://github.com/Brattlof)**
