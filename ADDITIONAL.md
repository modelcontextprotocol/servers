...
- **[asktian](https://github.com/douglasgan/tianprotocol/tree/main/mcp)** - Chinese metaphysics (bazi 八字, qimen 奇門, 5-element, daily 干支) as decision-support tools for AI agents. Ask "when should I do X" and get specific time windows instead of vague advice. 5 tools: daily reading, compatibility, best-time-for-action, today's energy, name analysis. (`npm install -g @asktian/mcp-server`) by **[asktian](https://github.com/douglasgan)**
