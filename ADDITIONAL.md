...
* **[GhostAPI](https://github.com/yiaany/ghostapi)** - Local API sandbox and MCP control plane for AI agents to safely emulate Stripe, OpenAI, Twilio, and GitHub locally.
