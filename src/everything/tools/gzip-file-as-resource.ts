import { z } from 'zod';
import { McpServer, CallToolResult, Resource } from '@modelcontextprotocol/server';
 ...
 */
async function fetchSafely(url: URL, { maxBytes, timeoutMillis }: { maxBytes: number; timeoutMillis: number }): Promise<ArrayBuffer> {
