...
describe('Registration Index Files', () => {
    describe('tools/index.ts', () => {
        it('should register all standard tools', async () => {
            ...
            const registeredTools = (mockServer.registerTool as any).mock.calls.map((call: any[]) => call[0]);
        ...
        it('should register conditional tools based on capabilities', async () => {
            ...
            const registeredTools = (mockServerWithCapabilities.registerTool as any).mock.calls.map((call: any[]) => call[0]);
    ...
    describe('prompts/index.ts', () => {
        it('should register all prompts', async () => {
            ...
            const registeredPrompts = (mockServer.registerPrompt as any).mock.calls.map((call: any[]) => call[0]);
    ...
    describe('resources/index.ts', () => {
        it('should register resource templates', async () => {
            ...
            const registeredResources = (mockServer.registerResource as any).mock.calls.map((call: any[]) => call[0]);
