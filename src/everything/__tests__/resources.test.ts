...
describe("Resource Templates", () => {
  ...
  describe("textResourceUri", () => {
    ...
    it("should handle different resource IDs", () => {
      expect(textResourceUri(5).toString()).toBe(
        "demo://resource/dynamic/text/5"
      );
      expect(textResourceUri(100).toString()).toBe(
        "demo://resource/dynamic/text/100"
      );
    });
  });
  ...
  describe("blobResourceUri", () => {
    ...
    it("should handle different resource IDs", () => {
      expect(blobResourceUri(5).toString()).toBe(
        "demo://resource/dynamic/blob/5"
      );
      expect(blobResourceUri(100).toString()).toBe(
        "demo://resource/dynamic/blob/100"
      );
    });
  });
...
describe("Session Resources", () => {
  describe("getSessionResourceURI", () => {
    it("should generate correct URI for resource name", () => {
      expect(getSessionResourceURI("test")).toBe(
        "demo://resource/session/test"
      );
    });

    it("should handle various resource names", () => {
      expect(getSessionResourceURI("my-file")).toBe(
        "demo://resource/session/my-file"
      );
