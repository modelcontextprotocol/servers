...
export const registerEmbeddedResourcePrompt = (server: McpServer) => {
    ...
    server.registerPrompt(
        ...
        args => {
            ...
            if (!RESOURCE_TYPES.includes(resourceType as typeof RESOURCE_TYPE_TEXT | typeof RESOURCE_TYPE_BLOB)) {
            ...
            const resource = resourceType === RESOURCE_TYPE_TEXT ? textResource(uri, resourceId) : blobResource(uri, resourceId);
