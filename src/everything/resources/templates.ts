import { z } from 'zod';
import { CompleteResourceTemplateCallback, McpServer, ResourceTemplate, completable } from '@modelcontextprotocol/server';
 ...
 */
export const resourceTypeCompleter = completable(z.string().describe('Type of resource to fetch'), (value: string) => {
 ...
 */
export const resourceIdForPromptCompleter = completable(z.string().describe('ID of the text resource to fetch'), (value: string) => {
 ...
 */
export const resourceIdForResourceTemplateCompleter: CompleteResourceTemplateCallback = (value: string) => {
    const resourceId = Number(value);
