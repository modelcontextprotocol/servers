...
export const funnelsModule = {
    tools: [
        ...
        },
        {
            ...
            description: "Open a funnel page in the editor and update headline/body/button text. Saves on completion.",
            inputSchema: {
                type: "object",
                properties: {
