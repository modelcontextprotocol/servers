...
export const emailBuilderModule = {
    tools: [
        {
            name: "ghl_browser_list_email_templates",
            description: "List email templates available in the GHL Email Builder. " +
        ...
        },
        {
            ...
            description: "Create a new email template in the GHL Email Builder. " +
        ...
        },
        {
            ...
            description: "Open an email template in the builder and update its subject line, preheader, " +
        ...
        },
        {
            ...
            description: "Open an email template and capture a screenshot of its rendered preview. " +
        ...
        },
        {
            ...
            description: "Send a test email for a template to one or more addresses. " +
        ...
        },
        {
            ...
            description: "Delete an email template. This action is irreversible.",
            inputSchema: {
                type: "object",
                properties: {
                    templateName: { type: "string" },
    ...
    handlers: {
        ...
        ghl_browser_delete_email_template: async (args) => {
            ...
            if (!confirm)
                throw new Error("confirm must be true to delete a template");
            if (!name && !id)
                throw new Error("templateName or templateId is required");
            const { page, close } = await openPage();
            try {
