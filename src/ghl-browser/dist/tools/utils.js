import { openPage, gotoGhl, isAuthenticated, clearState, screenshotError } from "../browser.js";
    ...
    tools: [
        {
            ...
            description: "Navigate to any GHL path and capture a screenshot. Useful for visual debugging of UI state.",
            inputSchema: {
                type: "object",
                properties: {
        ...
        },
        {
            ...
            description: "Check whether the stored browser session is still authenticated against GHL.",
            inputSchema: { type: "object", properties: {} },
        },
        {
            name: "ghl_browser_logout",
            description: "Clear the stored browser state so the next run requires a fresh login.",
            inputSchema: { type: "object", properties: {} },
        },
        {
            name: "ghl_browser_evaluate",
            description: "Navigate to a GHL path and run arbitrary JavaScript in the page context. Returns the JSON-serializable result.",
            inputSchema: {
                type: "object",
                properties: {
                    path: { type: "string" },
