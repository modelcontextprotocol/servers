...
export const reportingModule = {
    tools: [
        {
            ...
            description: "List available reports in the GHL reporting dashboard with name, category, " +
        ...
        },
        {
            ...
            description: "Create a custom report. Specify metrics, dimensions, date range, and filters. " +
        ...
        },
        {
            ...
            description: "Open a report and extract its data: table rows, chart values, summary metrics, " +
        ...
        },
        {
            ...
            description: "Export a report as CSV or PDF. Returns the file path of the downloaded export.",
            inputSchema: {
                type: "object",
                properties: {
        ...
        },
        {
            ...
            description: "Read the current dashboard summary metrics: total leads, conversions, revenue, " +
        ...
        },
        {
            ...
            description: "Delete a custom report. This action is irreversible.",
            inputSchema: {
                type: "object",
                properties: {
                    reportName: { type: "string" },
    ...
    handlers: {
        ...
        ghl_browser_delete_report: async (args) => {
            ...
            if (!confirm)
                throw new Error("confirm must be true to delete a report");
            if (!name && !id)
                throw new Error("reportName or reportId is required");
            const { page, close } = await openPage();
            try {
