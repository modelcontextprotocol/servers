...
export const proposalsModule = {
    tools: [
        {
            ...
            description: "List proposals and estimates with name, contact, amount, status (draft/sent/viewed/accepted/declined), " +
        ...
        },
        {
            ...
            description: "Create a new proposal or estimate. Returns the proposal name and URL after creation.",
            inputSchema: {
                type: "object",
                properties: {
        ...
        },
        {
            ...
            description: "Open a proposal and return its full structure: title, description, sections, " +
        ...
        },
        {
            ...
            description: "Add a section or line item to a proposal. " +
        ...
        },
        {
            ...
            description: "Send a proposal to the assigned contact via email. Returns the send status.",
            inputSchema: {
                type: "object",
                properties: {
                    proposalName: { type: "string" },
        ...
        },
        {
            ...
            description: "Update the status of a proposal: mark as draft, sent, accepted, or declined.",
            inputSchema: {
                type: "object",
                properties: {
                    proposalName: { type: "string" },
        ...
        },
        {
            ...
            description: "Delete a proposal or estimate. This action is irreversible.",
            inputSchema: {
                type: "object",
                properties: {
                    proposalName: { type: "string" },
    ...
    handlers: {
            ...
            try {
                return await withPageError(page, "proposals-add-section", async () => {
                    ...
                    const sectionOption = page
                        .locator(`button:has-text("${sectionType}"), ` +
        ...
        ghl_browser_delete_proposal: async (args) => {
            ...
            if (!confirm)
                throw new Error("confirm must be true to delete a proposal");
            if (!name && !id)
                throw new Error("proposalName or proposalId is required");
            const { page, close } = await openPage();
            try {
