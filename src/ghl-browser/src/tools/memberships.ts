...
export const membershipModule: ToolModule = {
  tools: [
    {
      name: "ghl_browser_list_memberships",
      description:
        "List membership products and courses with name, type (membership/course/offer), " +
    ...
    },
    {
      ...
      description:
        "Create a new membership product or course. Returns the name and URL after creation.",
      inputSchema: {
        type: "object",
        properties: {
    ...
    },
    {
      ...
      description:
        "Open a membership and return its full content hierarchy: offers, products, " +
    ...
    },
    {
      ...
      description:
        "Add content to a membership: a new course, module within a course, or lesson within a module. " +
    ...
    },
    {
      ...
      description:
        "Update membership settings: pricing, access control, drip schedule, " +
    ...
    },
    {
      ...
      description:
        "Delete a membership product or course. This action is irreversible.",
      inputSchema: {
        type: "object",
        properties: {
          membershipName: { type: "string" },
  ...
  handlers: {
        ...
        return await withPageError(page, "memberships-structure", async () => {
          ...
          const structure = await page.evaluate(() => {
            const courses: Array<{
              ...
              modules: Array<{
                title: string;
                lessons: Array<{ title: string; type: string; order: number }>;
                order: number;
              }>;
              order: number;
            }> = [];
              ...
              document.querySelectorAll(sel).forEach((courseEl, cIdx) => {
                ...
                courseEl
                  ...
                  .forEach((modEl, mIdx) => {
                    ...
                    const lessons: Array<{ title: string; type: string; order: number }> = [];
    ...
    ghl_browser_delete_membership: async (args) => {
      ...
      if (!confirm) throw new Error("confirm must be true to delete a membership");
      if (!name && !id) throw new Error("membershipName or membershipId is required");
