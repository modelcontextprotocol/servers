...
class SqliteDatabase:
    ...
    def _validate_identifier(self, identifier: str) -> str:
        ...
        Defense-in-depth: rejects identifiers with dangerous characters AND
        validates against actual database objects to prevent SQL injection.
        """
        # First layer: reject identifiers containing anything other than
        # alphanumeric, underscore, or dot (for schema-qualified names)
    ...
    def _validate_table_name(self, table_name: str) -> str:
        ...
        Whitelist approach: checks the table name against sqlite_master to
        ensure it corresponds to an actual table or view.
        """
        # Sanitize the identifier format first
        self._validate_identifier(table_name)

        # Then verify the table actually exists (whitelist validation)
