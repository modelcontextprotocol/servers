...
## Egress and Network Considerations

The embedded Chromium browser process automatically generates background network traffic (such as component updater, CRL sets, and captive portal / connectivity checks to Google endpoints like `clients2.google.com` and `accounts.google.com`) in addition to user-initiated navigation requests.

In egress-restricted or audited enterprise environments, these endpoints or proxy rules should be accounted for.
