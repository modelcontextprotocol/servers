...
import { LIST_TEMPLATES_TOOL, GET_TEMPLATE_TOOL, CREATE_FROM_TEMPLATE_TOOL, SAVE_TEMPLATE_TOOL, DELETE_TEMPLATE_TOOL, handleListTemplatesRequest, handleGetTemplateRequest, handleCreateFromTemplateRequest, handleSaveTemplateRequest, handleDeleteTemplateRequest } from './template-tools.js';
/**
 * Example of how to integrate Templates and Patterns with the Sequential Thinking server
 */
export function integrateTemplatesWithServer(server, thinkingServer) {
