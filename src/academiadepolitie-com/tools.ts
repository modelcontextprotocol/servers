...
class Tools {
  ...
  async executeTool(toolName: any, args: any, progressCallback: any) {
    ...
    if (postTools.includes(toolName)) {
      ...
      (requestOptions as any).body = postData.toString();
      console.log('POST Body:', (requestOptions as any).body);
    } else {
