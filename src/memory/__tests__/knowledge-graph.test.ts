...
describe('KnowledgeGraphManager', () => {
  ...
  describe('saveGraph locking', () => {
    it('should guarantee consistency: succeeded operations must be in file', async () => {
      const stressTestManager = new KnowledgeGraphManager(testFilePath, {
        retries: {
          retries: 100,
          minTimeout: 10,
          maxTimeout: 50,
      ...
      const minSuccessfulOperations = 100;
      ...
      expect(succeeded.length).toBeGreaterThanOrEqual(minSuccessfulOperations);
